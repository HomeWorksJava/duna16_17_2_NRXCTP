 ...
 * @author Norbi
 */
public class Szamologepem extends javax.swing.JFrame {

    /**
     * Creates new form Szamologepem
     */
  ...
  jLabel1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Szamologepem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Szamologepem().setVisible(true);
            }
        });
    }
